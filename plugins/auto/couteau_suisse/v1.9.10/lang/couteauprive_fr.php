...
- Version du fichier local : ',
	...
	'erreur:jquery' => '{{Note}} : la librairie {jQuery} semble inactive sur cette page. Veuillez consulter [ici->http://contrib.spip.net/?article2166] le paragraphe sur les dépendances du plugin ou recharger cette page.',
...
-* Articles : @_ART@.',
	...
	'outil_intro_old' => 'Cette interface est ancienne.<br /><br />Si vous rencontrez des problèmes dans l\'utilisation de la <a href=\'./?exec=admin_couteau_suisse\'>nouvelle interface</a>, n\'hésitez pas à nous en faire part sur le forum de <a href=\'http://contrib.spip.net/?article2166\'>contrib.spip</a>.',
