...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	...
	'texte_admin_tech_02' => '¡ATENCIÓN! Esta copia de respaldo SÓLO PODRÁ ser restaurada en un sitio que utiliza LA MISMA versión de SPIP. Por ningún motivo se deberá « vaciar la base » imaginando volver a instalar el respaldo después de una actualización. Consultar la <a href="@spipnet@">documentación de SPIP</a>.', # MODIF
	'texte_restaurer_base' => 'Restaurar el contenido de una copia de respaldo',
	'texte_restaurer_sauvegarde' => 'Esta opción te permite restaurar una copia de respaldo de la base efectuada anteriormente. A tal efecto, se debe haber puesto el archivo que contiene la copia de respaldo en la carpeta  @dossier@.
Prudencia con esta funcionalidad: <b>las modificaciones o pérdidas eventuales son irreversibles.</b>',
